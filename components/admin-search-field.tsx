...
export function AdminSearchField({ value, onChange, label, placeholder, onGlobalSearch, autoFocus, className }: {
  ...
  return <div className={cn("flex h-9 min-w-0 items-center gap-1 rounded-lg border border-border bg-background px-2 focus-within:border-ring focus-within:ring-2 focus-within:ring-ring/20", className)}>
